...
/**
 * =====================================================
 * 🔢 NUMERIC TREND API - ALL DURATIONS
 * =====================================================
 * 
 * Your real data source is HIDDEN - users only see your domain!
 * 
 * ENDPOINTS:
 * /api/numeric.php?api_key=KEY&duration=1min
 * /api/numeric.php?api_key=KEY&duration=3min
 * /api/numeric.php?api_key=KEY&duration=5min
 * 
 * =====================================================
 */
...
$duration_map = [
    '1min'  => ['typeId' => 'num_1', 'name' => 'Numeric 1 Minute'],
    '1'     => ['typeId' => 'num_1', 'name' => 'Numeric 1 Minute'],
    '3min'  => ['typeId' => 'num_3', 'name' => 'Numeric 3 Minutes'],
    '3'     => ['typeId' => 'num_3', 'name' => 'Numeric 3 Minutes'],
    '5min'  => ['typeId' => 'num_5', 'name' => 'Numeric 5 Minutes'],
    '5'     => ['typeId' => 'num_5', 'name' => 'Numeric 5 Minutes'],
];
...
if (!isset($duration_map[$duration])) {
    json_response([
        ...
        'example' => '/api/numeric.php?api_key=YOUR_KEY&duration=1min'
    ], 400);
}
...
if (!empty($key_data['game_type']) && $key_data['game_type'] !== 'all') {
    ...
    if (!in_array('numeric', $allowed_games)) {
        json_response([
            'success' => false,
            'error' => 'Your API key does not have access to Numeric',
