...
/**
 * =====================================================
 * 🎲 K3 TREND API - ALL DURATIONS
 * =====================================================
 * 
 * Your real data source is HIDDEN - users only see your domain!
 * 
 * ENDPOINTS:
 * /api/k3.php?api_key=KEY&duration=1min
 * /api/k3.php?api_key=KEY&duration=3min
 * /api/k3.php?api_key=KEY&duration=5min
 * /api/k3.php?api_key=KEY&duration=10min
 * 
 * =====================================================
 */
...
$duration_map = [
    '1min'  => ['typeId' => 'k3_1', 'name' => 'K3 1 Minute'],
    '1'     => ['typeId' => 'k3_1', 'name' => 'K3 1 Minute'],
    '3min'  => ['typeId' => 'k3_3', 'name' => 'K3 3 Minutes'],
    '3'     => ['typeId' => 'k3_3', 'name' => 'K3 3 Minutes'],
    '5min'  => ['typeId' => 'k3_5', 'name' => 'K3 5 Minutes'],
    '5'     => ['typeId' => 'k3_5', 'name' => 'K3 5 Minutes'],
    '10min' => ['typeId' => 'k3_10', 'name' => 'K3 10 Minutes'],
    '10'    => ['typeId' => 'k3_10', 'name' => 'K3 10 Minutes'],
];
...
if (!isset($duration_map[$duration])) {
    json_response([
        ...
        'example' => '/api/k3.php?api_key=YOUR_KEY&duration=1min'
    ], 400);
}
...
if (!empty($key_data['game_type']) && $key_data['game_type'] !== 'all') {
    ...
    if (!in_array('k3', $allowed_games)) {
        json_response([
            'success' => false,
            'error' => 'Your API key does not have access to K3',
